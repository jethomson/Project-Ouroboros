 ...
 * Modified by: Jonathan Thomson
 * Creation Date: 2007-12-08
 * Modification Date: 2019-02-18
 * Tabsize: 4
...
/* Modifications added by Jonathan Thomson to add capability to enter
 * bootloader on a button press or automatically after a reset
 * see: https://jethomson.wordpress.com/2011/08/18/project-ouroboros-reflashing-a-betemcu-usbasp-programmer/
 */
